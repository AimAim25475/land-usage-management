...
from utils.plot import visualize_with_graph
...
if __name__ == "__main__":
    ...
    interpreter = tf.lite.Interpreter(model_path="d:/testing deploy on hugging face/LandManagement_backup/flutter_application_1/models/model.tflite")
    ...
    input_shape = input_details[0]['shape']  # [1, 3, 512, 512]
    ...
    try:
        for filename in img_list:
            ...
            try:
                plot_fig = visualize_with_graph(
                image=image,
                predicted_mask=pred_mask,
                class_labels=['background', 'building', 'water', 'woodland']  # Update as needed
        )
